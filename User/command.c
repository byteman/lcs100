...
void  Baud_Rate(void)      //设置通讯波特率
{
    ...
    switch(b_rate)
          {
          case 0: rate=2400; break;
          case 1: rate=4800; break;
          case 2: rate=9600; break;
          case 3: rate=19200; break;
          case 4: rate=38400; break;
          case 5: rate=43000; break;
          case 6: rate=56000; break;
          case 7: rate=57600; break;
          default : rate=19200; break;
          }     
      UARTInit(rate);
